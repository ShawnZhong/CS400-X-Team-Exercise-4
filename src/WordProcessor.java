...
<<<<<<< HEAD
    ...
    public class WordProcessor {
        ...
        public static Stream<String> getWordStream(String filepath) throws IOException {
             ...
             */
            try {
                Stream<String> wordList = Files.lines(Paths.get(filepath));
                wordList = wordList.map(String::trim)..filter(x -> x!=null && !x.equals("")).map(String::toUpperCase);
                return wordList;
            } catch (IOException e) {
                System.out.println("Cannot access words from given filepath");
            } 
            return null;
        }
...
public class WordProcessor {
	...
	public static Stream<String> getWordStream(String filepath) throws IOException {
		...
		try {
		    Stream<String> wordList = Files.lines(Paths.get(filepath));
		    wordList = wordList.map(String::trim).map(String::toUpperCase).filter(x -> !x.equals(""));
		    return wordList;
		} catch (IOException e) {
		    System.out.println("Cannot access words from given filepath");
		} 
...
>>>>>>> parent of 7a980cd... Change to follow the flow of Deb's logic
...
>>>>>>> 3975408dc03011631fd3e32ebd3c6e04305bc139
                }
                if (sum == 1)
                    return true;
=======
